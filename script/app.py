...
def retime_video(input_video_path, timecode_path, output_retimed_video_path):
    ...
    command = [binary, "-t", timecode_path, input_video_path, output_retimed_video_path]
    run_command(command)
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            paths = {
                ...
                "final_output": os.path.join(temp_dir, "synchronized_output.mp4")
            }
            ...
            mux_final_output(paths["retimed_video"], target_audio_path, paths["final_output"])
            
            duration = time.time() - start_time
            status_msg = f"Synchronization successful! Processed in {duration:.2f} seconds.\n\n--- Transcript Preview ---\n{transcript_text[:1000]}..."
            return paths["final_output"], status_msg
